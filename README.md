...
- Installs dependencies into `.python_packages/lib/site-packages`
- Creates and uploads deployment artifact
- Logs into Azure and deploys with `Azure/functions-action@v1`

Ensure repository secrets referenced in the workflow are configured in GitHub.
